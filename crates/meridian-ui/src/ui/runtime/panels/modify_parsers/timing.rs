...
pub(in super::super) fn format_tempo_points(points: &[TempoPoint]) -> String {
    points
        .iter()
...
pub(in super::super) fn parse_tempo_points(raw: &str) -> Result<Vec<TempoPoint>, String> {
    let mut points = Vec::new();
    for entry in csv_parts(raw) {
...
pub(in super::super) fn format_time_warp_points(points: &[TimeWarpPoint]) -> String {
    points
        .iter()
...
pub(in super::super) fn parse_time_warp_points(raw: &str) -> Result<Vec<TimeWarpPoint>, String> {
    let mut points = Vec::new();
