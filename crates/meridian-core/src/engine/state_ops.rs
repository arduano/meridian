...
impl CoreState {
    ...
    pub(super) fn snapshot(&self) -> StateSnapshot {
        ...
        StateSnapshot {
            ...
            active_video_render_job_id: self.active_video_render_job_id_from_state(),
            active_audio_render_job_id: self.active_audio_render_job_id_from_state(),
            active_midi_process_job_id: self.active_midi_process_job_id_from_state(),
