...
use crate::midi::{MIDI_KEY_COUNT, MIDIFileUnion, MIDIFileViewsUnion};

use super::{
    NOTE_DEPTH_STEP, NoteInstance, ProjectedScene, SceneLayer, SceneLayout, SceneProjector,
    is_black_key, mod_add, quad, vertical_gradient_quad,
};
            ...
            .map(|k| {
                ...
                for note in iter {
                    ...
                    projected_notes.push(NoteInstance {
                        ...
                        x2,
                        y2: top,
                        left_color: packed_color,
                        right_color: packed_color,
                        pad_x: params.padding_x,
                        pad_y: params.padding_y,
                        depth: 0.0,
                        _padding: [0; 3],
                    });
                }
